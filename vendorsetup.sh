...
git clone --depth=1 https://github.com/mt6893-amber/android_vendor_xiaomi_amber.git -b V816.0.3.0.UKWMIXM vendor/xiaomi/amber

echo 'Cloning Kernel tree [2/5]'
# Kernel Tree
rm -rf device/xiaomi/amber-kernel
git clone --depth=1 https://github.com/mt6893-amber/android_kernel_xiaomi_amber-prebuilt.git -b V816.0.3.0.UKWMIXM device/xiaomi/amber-kernel
